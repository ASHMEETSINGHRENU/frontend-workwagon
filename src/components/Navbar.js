          ...
          <div className="hidden md:flex flex-1 mx-6 max-w-md">
            <div className="relative w-full">
              <input
                ...
                className="w-full px-4 py-2 pl-10 rounded-full border border-gray-200 bg-gray-50/50 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-400 focus:border-transparent transition-all duration-200"
              />
