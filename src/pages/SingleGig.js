...
import { 
  ...
  FaCode, FaMobile, FaDatabase, FaServer, FaShoppingCart,
  FaHeart, FaShare, FaArrowLeft, FaWhatsapp, FaEnvelope,
  FaCreditCard, FaLock, FaCalendarCheck, FaUserTie
} from "react-icons/fa";

const SingleWebsiteGig = () => {
  const { id } = useParams();
  ...
  const skills = [
    { icon: <FaCode />, name: "React.js", level: 95 },
    { icon: <FaMobile />, name: "Responsive Design", level: 98 },
    { icon: <FaDatabase />, name: "Database", level: 90 },
    { icon: <FaServer />, name: "Backend", level: 85 },
    { icon: <FaShoppingCart />, name: "E-commerce", level: 88 },
  ];
      ...
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-8 md:py-12">
          ...
          <motion.button
            ...
            onClick={() => navigate("/website")}
            className="mb-6 flex items-center gap-2 text-gray-600 hover:text-blue-600 transition-all duration-200 bg-white/60 backdrop-blur-sm px-4 py-2 rounded-full shadow-sm"
          >
            ...
            <div className="flex flex-wrap justify-between items-start gap-4">
              ...
              <div className="flex gap-3">
                ...
                <motion.button
                  whileHover={{ scale: 1.1 }}
                  whileTap={{ scale: 0.9 }}
                  className="p-3 rounded-full bg-white/80 backdrop-blur-sm text-gray-600 hover:text-blue-600 transition-all"
                >
                  <FaShare />
                </motion.button>
              </div>
                ...
                <div className="relative h-96 overflow-hidden">
                  {gig.img ? (
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center">
                      <FaCode className="text-white text-8xl opacity-50" />
                    </div>
                  )}
              ...
              <motion.div variants={sectionVariants} className="bg-white/40 backdrop-blur-xl rounded-3xl p-6 md:p-8 shadow-xl border border-white/50">
                ...
                <div className="flex items-center gap-4 mb-6 pb-6 border-b border-gray-200">
                  ...
                  <div>
                    ...
                    <p className="text-gray-500">Web Developer | {gig.level || "Expert"} Level</p>
                  </div>
                </div>
                <p className="text-gray-600 leading-relaxed whitespace-pre-line">
                  {gig.about || "Professional web developer with years of experience creating stunning, responsive websites. Specialized in modern frameworks and best practices to deliver high-quality solutions that meet client needs."}
                </p>
              </motion.div>
                ...
                <div className="p-6">
                        ...
                        <motion.div
                          ...
                          className={`cursor-pointer p-4 rounded-xl border-2 transition-all duration-300 ${
                            selectedPackage === pkg.id
                              ? `border-blue-500 bg-gradient-to-r ${pkg.color} bg-opacity-10 shadow-lg`
                  ...
                  <div className="space-y-3">
                    <motion.button
                      ...
                      className="w-full py-3 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold shadow-lg hover:shadow-xl transition-all flex items-center justify-center gap-2"
                    >
                      <FaEnvelope />
                      Connect With Us
                    </motion.button>
              ...
              {[1, 2, 3].map((review, idx) => (
                <div key={idx} className="pb-6 border-b border-gray-200 last:border-0">
                  ...
                  <p className="text-gray-600">
                    {idx === 0 && "Excellent work! The website exceeded our expectations. Highly recommended!"}
                    {idx === 1 && "Great communication and delivered before deadline. Will work again!"}
                    {idx === 2 && "Professional developer with amazing skills. The website looks fantastic!"}
                  </p>
                </div>
              ))}
            </div>
...
export default SingleWebsiteGig;